...
public:
	...
	bool isMoving();
	void setPrevState(gameObjectConst::MoveDirectionState dir);
	gameObjectConst::MoveDirectionState getPrevState();
	void simulate(GLfloat sec);
	void draw(void);
protected:
	glm::vec3 position;
	gameObjectConst::MoveDirectionState prevState;
private:
	bool isFacticalPositionSet;
	bool isMovingDone();
